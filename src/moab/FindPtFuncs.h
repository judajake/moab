...
void MOAB_EXPORT findpt_weights_2(findpt_data_2 *p, const real r[2]);

void MOAB_EXPORT findpt_weights_3(findpt_data_3 *p, const real r[3]);

double MOAB_EXPORT findpt_eval_2(findpt_data_2 *p, const real *u);

double MOAB_EXPORT findpt_eval_3(findpt_data_3 *p, const real *u);
...
extern const unsigned MOAB_EXPORT opt_no_constraints_2;
extern const unsigned MOAB_EXPORT opt_no_constraints_3;
...
#ifdef __GNUC__
void MOAB_EXPORT fail(const char *fmt, ...) __attribute__ ((noreturn));
#define MAYBE_UNUSED __attribute__ ((unused))
#else
void MOAB_EXPORT fail(const char *fmt, ...);
#define MAYBE_UNUSED
#endif
